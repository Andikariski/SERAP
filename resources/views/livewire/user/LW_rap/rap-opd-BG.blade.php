    ...
    {{-- @if($getPaguOPD->pagu_BG == 0)
        <div class="alert alert-warning d-flex align-items-center" role="alert">
            <div>
                ...
                Pagu Dana Otsus Block Grand (BG) Anda sebesar <strong>0</strong>. Silakan hubungi administrator, jika membutuhkan informasi lebih lanjut.
            </div>
        </div>
    @elseif($getPaguOPD->pagu_BG !=0) --}}
        ...
        <ul class="p-2 m-0">
            <li class="mb-2 d-flex align-items-center">
                ...
                <div class="d-flex align-items-center me-3" style="width: 40%;">
                    ...
                    @endif
                    <div>
                        <h5 class="mb-0 fw-semibold text-truncate" title="Dana Otsus Block Grand">Dana Otsus Block Grant</h5>
        ...
        <div class="col-md-8 d-flex justify-content-end">
            ...
            @elseif($statusAkses === 'Buka')
                {{-- Jika persentase masih kurang dari 100 → tombol aktif --}}
                 @if(!$is_disabled) 
                    <a href="{{ route('opd.rap.create',['type' => 'rap-opd-bg']) }}" 
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 d-flex gap-2">
                            @if($statusAkses === 'Buka')
                                 ...
                                 <a href="{{ route('opd.rap.update',['id' => $rap->id, 'type' => 'rap-opd-bg']) }}" 
